...
import amazonsource.WishList;

public class TestCase1 extends LaunchQuit
//login-> searchingshoe -> adding the shoe in wishlist -> adding it to cart -> 
//making the payment using cod
{
	@Test
	public void bookingtheproductusingCOD() throws InterruptedException
	{
	...
	Cart c1 = new Cart(driver);
		...
		c1.paymentoption1();
		Thread.sleep(3000);
		Reporter.log("Test Case 1 Pass");//use this only in TestNG
	}
}
